...
namespace oat\taoCuriosity\model\theme;
...
/**
 * Class TaocuriosityDefaultTheme
 *
 * @package oat\taoCuriosity\model\theme
 */
class TaocuriosityDefaultTheme extends DefaultTheme
{

    /**
     * Id of this extension
     */
    const EXTENSION_ID = 'taoCuriosity';


    /**
     * Theme's label
     */
    const THEME_LABEL = 'taoCuriosity default theme';


    /**
     * Theme's id, by default label without spec chars
     */
    const THEME_ID = 'taocuriosityDefaultTheme';
